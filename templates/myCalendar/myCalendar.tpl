...
#SHEET
  ...
  #TAB('&Defaults')
    #BOXED('Language')
      #PROMPT('Calendar &language:',DROP('English[1]|Espa�ol (Spanish)[2]')),%mdgLanguage,DEFAULT('1')
...
#SHEET
  ...
  #TAB('&View')
    ...
    #ENDBOXED
    #BOXED('Language')
      #PROMPT('&Language:',DROP('Use the application setting[0]|English[1]|Espa�ol (Spanish)[2]')),%mdLang,DEFAULT('0')
...
#SHEET
  ...
  #TAB('&View')
    #BOXED('How much is on screen')
      ...
      #PROMPT('&Language:',DROP('Use the application setting[0]|English[1]|Espa�ol (Spanish)[2]')),%mnLang,DEFAULT('0')
    #ENDBOXED
  #ENDTAB
  #TAB('&Limits')
    #BOXED('Which days may be picked')
