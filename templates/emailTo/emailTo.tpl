#TEMPLATE(emailTo,'emailTo - Send e-mail from Clarion and manage the account: SMTP/TLS, OAuth2 and nine provider APIs - v1.10 (2026-08-24 22:20)'),FAMILY('ABC')
#!
...
#SHEET
  #TAB('&General')
    #BOXED('emailTo')
      #DISPLAY('emailTo v1.10  -  built 2026-08-24 22:20')
