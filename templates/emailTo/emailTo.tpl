#TEMPLATE(emailTo,'emailTo - Send e-mail from Clarion and manage the account: SMTP/TLS, OAuth2 and nine provider APIs - v1.08 (2026-08-24 21:40)'),FAMILY('ABC')
#!
...
#SHEET
  #TAB('&General')
    #BOXED('emailTo')
      #DISPLAY('emailTo v1.08  -  built 2026-08-24 21:40')
